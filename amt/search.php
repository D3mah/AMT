				...
				<div class="uk-width-1-1">
					...
					<div class="uk-section post-top">
						...
						<div class="form-search">
							<form class="uk-search uk-navbar" role="search" method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
								<input class="uk-search-input uk-navbar-left" type="text" value="<?php echo get_search_query(); ?>" name="s" id="s" placeholder="Поиск..." autofocus >
